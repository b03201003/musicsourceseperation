...
class LSTM():
	def __init__(self,input_shape=(100,15,1025)):
		...
		self.model.add(TimeDistributed(Dense(50,activation = 'relu'), batch_input_shape=input_shape))
		self.model.add(CuDNNLSTM(30,return_sequences=True,stateful=True))
		self.model.add(Activation('relu'))
		self.model.add(CuDNNLSTM(20,return_sequences=True,stateful=True))
		self.model.add(Activation('relu'))
